...
if(isset($_GET['pro_id'])){
  ...
  $p_img5 = $row_product['product_img5'];
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ml-auto">
            ...
            <li class="nav-item nav_item2"><a class="nav nav-link" href="trimer.php">Shop</a></li>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-12 col-12 mt-2 pt-3">
          ...
          <div class="small_img_group mt-2">
            ...
            <div class="small_img_col">
              <img src="admin_area/product_images/<?php echo $p_img4 ?>" class="small_img" width="100%" alt="p1">
            </div>
            <div class="small_img_col">
              <img src="admin_area/product_images/<?php echo $p_img5 ?>" class="small_img" width="100%" alt="p1">
            </div>
          </div>
        </div>
        <div class="details col-lg-6 col-md-12 col-12 mt-2 pt-3">
          <h2 class="mb-3 tittle"><?php echo $p_title ?></h2>
          <h4 class="mb-4"><i class="fa-solid fa-paintbrush"></i>Art created by <span> <?php echo $artist_name ?> </span></h4>
          ...
          <form action="details.php?add_cart=<?php echo $pro_id; ?>" method="post">
            ...
            <div class="buy container-fluid">
              ...
              <button class="buy_btn" type="submit" name="add_to_cart">Buy Now</button>
            </div>
          </form>
          ...
          <ul class="px-4">
            ...
            <li>Glass (Set of 1): A handcrafted glass, adorned with subtle Alpona-inspired details, adding a touch of sophistication to your wedding table. Capacity: 16 ounces.</li>
          </ul>
        </div>
      </div>
    </section>
