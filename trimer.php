  ...
  <body>
     ...
     <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
          <a class="logo" href="index.php">Art World</a>
          ...
          <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ml-auto">
              ...
              <li class="nav-item "><a class="nav nav-link" href="#artwork">Shop</a></li>
              ...
              <li class="nav-item "><a class="nav nav-link" href="#contact">Contact</a></li>
              ...
              <?php
                if(!isset($_GET['p_cat']) && !isset($_GET['cat_id'])) {
                  ...
                  echo "<li class='page-item " . ($page == 1 ? 'disabled' : '') . "'>
                          <a class='page-link' href='trimer.php?page=" . ($page - 1) . "' tabindex='-1' aria-disabled='true'>Previous</a>
                        </li>";

                  for ($i = 1; $i <= $total_pages; $i++) {
                    echo "<li class='page-item " . ($i == $page ? 'active' : '') . "'>
                            <a class='page-link' href='trimer.php?page=" . $i . "'> " . $i . " </a>
                          </li>";
                  }

                  echo "<li class='page-item " . ($page == $total_pages ? 'disabled' : '') . "'>
                          <a class='page-link' href='trimer.php?page=" . ($page + 1) . "'>Next</a>
                        </li>";
                }
              ?>
            </ul>
